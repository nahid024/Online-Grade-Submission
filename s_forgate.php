...
if(isset($_POST['submit'])){
    ...
    try{
        ...
        $statement = $db->prepare("select * from student where s_email=?");
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<li class="nav-item active">
			<a class="nav-link" href="f_index.php">Faculty <span class="sr-only">(current)</span></a>
			</li>
			<li class="nav-item active">
			<a class="nav-link" href="s_login.php">Student <span class="sr-only">(current)</span></a>
			</li>
			<li class="nav-item active">
			<a class="nav-link" href="admin_index.php">Admin <span class="sr-only">(current)</span></a>
			</li>
        ...
        <div class="container">
            <div class="login-form">
                ...
                <form action="" method="POST">
                    <input type="text" name="email" placeholder="inter your email">
                        <br>
